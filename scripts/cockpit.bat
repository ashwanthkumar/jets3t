...
set CP=%CP%;%MY_JETS3T_HOME%/libs/httpcomponents/httpclient-4.3.5.jar
set CP=%CP%;%MY_JETS3T_HOME%/libs/httpcomponents/httpcore-4.3.2.jar
...
set CP=%CP%;%MY_JETS3T_HOME%/libs/bouncycastle/bcprov-jdk15on-151.jar
set CP=%CP%;%MY_JETS3T_HOME%/libs/java-xmlbuilder/java-xmlbuilder-1.0.jar
