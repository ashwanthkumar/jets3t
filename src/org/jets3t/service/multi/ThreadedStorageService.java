...
public class ThreadedStorageService {
     ...
     * of 500ms.
     *
     * @param service  an storage service implementation that will be used to perform requests.
     ...
     * time interval.
     *
     * @param service           a storage service implementation that will be used to perform requests.
     * @param listener          the event listener which will handle event notifications.
    ...
    /**
     * @return true if the underlying service implementation is authenticated.
     */
     ...
     * <tt>threaded-service.admin-max-thread-count</tt>.
     *
     * @param bucketNames names of buckets to create.
     * @return true if all the threaded tasks completed successfully, false otherwise.
     */
     ...
     *
     * @param bucketName name of the bucket where objects will be stored
     ...
     * <tt>threaded-service.admin-max-thread-count</tt>.
     *
     * @param bucketName name of the bucket containing objects to delete
     ...
     * <tt>threaded-service.admin-max-thread-count</tt>.
     *
     * @param bucketName name of the bucket containing the objects to be deleted
     ...
     *
     * @param bucketName name of the bucket containing the objects whose details will be retrieved.
